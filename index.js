...
function getCarInfoByIndex(inventory, index) {
  let num = inventory[index];
  return "This is a " + num.car_make + " " + num.car_model;
}
 ...
 * it will return `This is a Lincoln Navigator`.
*/
function getCarInfoById(arr, idSel) {
  var i = 0;
  var index = arr[i];
  if (index.id === idSel){
    var word = `This is a ${index.car_make} ${index.car_model}`; 
  }
